...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Fatura}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FaturaResource {
     ...
     */
    @PostMapping("/faturas")
    public ResponseEntity<Fatura> createFatura(@Valid @RequestBody Fatura fatura) throws URISyntaxException {
     ...
     */
    @PutMapping("/faturas")
    public ResponseEntity<Fatura> updateFatura(@Valid @RequestBody Fatura fatura) throws URISyntaxException {
